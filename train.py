...
if __name__ == '__main__':
    ...
    # Training parameters
    parser.add_argument('--epochs',         type=int,   default=70,                                 help='number of epochs to train for (if early stopping is not triggered).') #80, 26
    ...
    if args.dataset_type == 'endovis':
        ...
        '''
        # tokenizer
        tokenizer = BertTokenizer.from_pretrained('/content/drive/MyDrive/vision_language_project/Surgical-VQLA/dataset/bertvocab/v2/bert-EndoVis-18-VQA/')
        ...
        folder_head = '/content/drive/MyDrive/vision_language_project/Surgical-VQLA/dataset/EndoVis-18-VQLA/seq_'
        ...
        # external dataloader
        external_folder_head = '/content/drive/MyDrive/vision_language_project/Surgical-VQLA/dataset/EndoVis-17-VQLA/'
    ...
    if args.checkpoint is None:
        ...
        for key in final_args.keys(): args._setattr_(key, final_args[key])
